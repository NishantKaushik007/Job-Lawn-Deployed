...
export default function PremiumCard() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-black p-4">
      <div className="relative w-full max-w-sm rounded-3xl bg-black border border-amber-500/30 p-6 overflow-hidden">
        ...
        {/* Description */}
        <p className="text-gray-400 text-sm mb-6">Enjoy unlimited access to tailored job openings and career opportunities with our subscription service.</p>

        {/* Features list */}
        <ul className="space-y-3 mb-8">
          {["Pay After Using 30 Days", "Access To Newly Added Compaines", "Unlimited Job Searching", "Customized Filters", "24/7 Availablity" ].map((feature, index) => (
