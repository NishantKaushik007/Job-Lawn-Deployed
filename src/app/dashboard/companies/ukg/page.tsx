...
// Server-side component updated to expect searchParams as a Promise
export default async function UKGPage({ searchParams: rawSearchParams }: { searchParams: Promise<Record<string, string>> }) {
  // Await the promise to obtain the actual search parameters
