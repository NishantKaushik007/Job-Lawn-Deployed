...
async function fetchJobs(
  ...
  if (facets.country && facets.country.length > 0) {
    appliedFacets.locationHierarchy1 = facets.country;
  }
  ...
  const jobsEndpoint = "https://nvidia.wd5.myworkdayjobs.com/wday/cxs/nvidia/NVIDIAExternalCareerSite/jobs";
  ...
  const jobs: Job[] = data.jobPostings.map((job: any) => {
    return {
      ...
      jobLink: `https://nvidia.wd5.myworkdayjobs.com/en-US/NVIDIAExternalCareerSite${job.externalPath}`,
      descriptionLink: `https://nvidia.wd5.myworkdayjobs.com/wday/cxs/nvidia/NVIDIAExternalCareerSite${job.externalPath}`,
      description: ""
    };
  });
