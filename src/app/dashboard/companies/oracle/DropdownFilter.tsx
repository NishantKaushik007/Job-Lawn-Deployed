...
interface DropdownProps {
  ...
  postingDate: { company: string; value: string; code: string }[];
...
const DropdownFilter: React.FC<DropdownProps> = ({
  ...
  return (
    <div className="flex flex-col mb-6 space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0 w-full">
      ...
      />
      <Select
        value={getSelectedValue('postingDate', postingDate)}
        onChange={handleDropdownChange('postingDate')}
        options={transformOptions(postingDate)}
        className="w-full"
