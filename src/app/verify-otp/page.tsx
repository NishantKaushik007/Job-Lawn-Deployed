...
function VerifyOtpContent() {
  ...
  // Automatically resend OTP when the component mounts
  useEffect(() => {
    handleResendOtp();
  }, []);
    ...
    <div className="min-h-screen bg-[#1c1c1c] flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md p-8 bg-[#2a2a2a]/50 rounded-2xl backdrop-blur-xl border border-zinc-800 relative z-10">
        ...
        <form onSubmit={handleVerifyOtp} className="space-y-6">
          ...
          <Button type="submit" className="w-full bg-gradient-to-r from-[#6366f1] to-[#f59e0b] text-white hover:to-[#f59e0b] relative overflow-hidden h-12">
